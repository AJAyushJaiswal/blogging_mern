...
import {publishBlog, updateBlog, deleteBlog, getMyBlog, getAllMyBlogs, getBlog, getAllBlogs, getWriterBlogs} from '../controllers/blog.controllers.js';
...
router.route('/w/:userId').get(getWriterBlogs);
